          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl max-w-lg w-full shadow-2xl border border-gray-200 dark:border-gray-700 p-6 animate-in fade-in zoom-in-95">
            ...
            <form onSubmit={handleCreateProduct} className="space-y-4">
              ...
              <div className="pt-3 border-t border-gray-200 dark:border-gray-700 flex items-center justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-xs font-bold bg-brand-500 hover:bg-brand-600 text-white rounded-xl shadow-xs"
                >
                  Create Product
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-[99999] bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-3xl max-w-lg w-full shadow-2xl border border-gray-200 dark:border-gray-700 p-6 animate-in fade-in zoom-in-95">
            ...
            <form onSubmit={handleSaveTokenAndSync} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">
                  Admin API Access Token * (<span className="text-emerald-600">shpat_...</span>)
                </label>
                <input
                  type="password"
                  required
              ...
              <div className="pt-3 border-t border-gray-200 dark:border-gray-700 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-xs flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                >
                  <FiCheck className="w-3.5 h-3.5" />
                  {savingToken ? "Saving & Syncing..." : "Save & Sync Products"}
                </button>
              </div>
            </form>
          </div>
